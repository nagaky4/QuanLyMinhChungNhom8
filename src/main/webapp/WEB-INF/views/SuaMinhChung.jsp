	...
	<div id="admin-content">
		...
		<div class="main-content-wrap">
			<div class="main-content">
				...
				<div class="list-wrap">
					<h3 class="form-title">Sửa minh chứng</h3>
					<div class="container">
					  <form action="/suaMC?maMC=${mc.getMaMC() }" method="post">
					  
					    <div class="form-group">
					      <label class="control-label col-sm-2" for="email">Tên minh chứng</label>
					      <div class="col-sm-10">
							<input type="text" class="form-control" name="TenMC" value="${mc.getTenMC() } "/>					       
					      </div>
					    </div>
					    ...
					    <div class="form-group">
					      ...
					      <div class="col-sm-10"> 
							<input type="text" class="form-control" id="pwd" name="NoiDung" value="${mc.getNoiDung() }"/>        					        
					      </div>
					    </div>
					    ...
					    <div class="form-group" style="padding-top:15px;padding-bottom:15px;">
							...
							<select name="MaLoaiMC" id="ddlViewBy">
					    ...
					    <div class="form-group">
							...
							<input type="file"  name="HinhAnhMoTa" value="${mc.getHinhAnhMoTa() }"/> 					              			
						</div>
					    	
					    <div class="form-group">
					    	<label class="control-label col-sm-2" for="pwd">Hình ảnh minh chứng: </label>     
							<input type="file"  name="HinhAnhMC" value="${mc.getHinhAnhMC() }"/>  			
						</div>
...
<div id="footer">
	<h1>Design by: Nhom 9<a href=""></a></h1>
</div><!--end #footer-->
